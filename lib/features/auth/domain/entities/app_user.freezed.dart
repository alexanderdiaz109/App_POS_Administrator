...
@override
String toString() {
  return 'AppUser(id: $id, storeId: $storeId, nombre: $nombre, correo: $correo, rol: $rol, activo: $activo)';
}
...
class _AppUser implements AppUser {
  const _AppUser({required this.id, @JsonKey(name: 'store_id') required this.storeId, required this.nombre, required this.correo, required this.rol, required this.activo});
